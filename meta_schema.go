...
func (t AnyOfJSONSchemaUnorderedSetOfJSONSchemawrpyYBUSSidr3R5Q) MarshalJSON() ([]byte, error) {
  ...
  return json.Marshal(t.UnorderedSetOfJSONSchemawrpyYBUS)
}

func (t *AnyOfJSONSchemaUnorderedSetOfJSONSchemawrpyYBUSSidr3R5Q) UnmarshalJSON(data []byte) error {
  var first byte
  if len(data) > 1 {
    first = data[0]
  }
  if first == '[' {
    var parsed = UnorderedSetOfJSONSchemawrpyYBUS{}
    if err := json.Unmarshal(data, &parsed); err != nil {
      return err
    }
    t.UnorderedSetOfJSONSchemawrpyYBUS = &parsed
    return nil
  }
...
type JSONSchema struct {
	...
	MinItems             *Integer7Bd9WOt2                   `json:"minItems,omitempty"`
	...
	MinProperties        *Integer7Bd9WOt2                   `json:"minProperties,omitempty"`
